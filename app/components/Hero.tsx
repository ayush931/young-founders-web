    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center">
          <div
            className={`md:w-1/2 mb-12 md:mb-0 transition-all duration-1000 transform ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-12 opacity-0'
              }`}
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-black mb-6">
              Stack Your <span className="text-[#f57d56]">Skills</span> <br />
              Build Your <span className="text-[#f57d56]">Future</span> 
            </h1>
          ...
          <div
            className={`md:w-1/2 transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-12 opacity-0'
              }`}
          >
            <div className="bg-white rounded-2xl shadow-2xl p-6 relative overflow-hidden border-t-4 border-[#f57d56]">
              ...
              <h2 className="text-2xl font-bold mb-6 text-black">Why Choose Stack Skills?</h2>
